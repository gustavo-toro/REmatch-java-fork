...
public class Query extends Pointer {
    ...
    public static void main(String[] args) {
        ...
        // Query query = new Query(pattern, flags.getVal(), maxMempoolDuplications,
        ...
        // System.out.println("——— Variables encontradas en el match (desde Query): " +
        // vars.size());
        ...
        // System.out.println("————— Span de inicio por id: " +
        // result.start(variableIdFindone));
        // System.out.println("————— Span de inicio por variable: " +
        // result.start("x"));
        // System.out.println("—— MATCH::END()");
        // System.out.println("————— Span de fin por id: " +
        // result.end(variableIdFindone));
        ...
        // System.out.println(
        // "————— Span por id (first, second): " + result.span(0).first() + ", " +
        // result.span(0).second());
        // System.out.println("————— Span por variable (first, second): " +
        // result.span("x").first() + ", "
        // + result.span("x").second());
        // System.out.println("—— MATCH::GROUPDICT()");
        // System.out.println("————— Diccionario de grupos por variable (first, second):
        // "
        ...
        // System.out.println("————— Variables encontradas en el match (desde Match): "
        // + vars_match.size());
        ...
        // System.out.println("—— Matches encontradas para búsqueda de " + findNumber +
        // ": " + matches.size());
        ...
        // MatchIterator it = matchGenerator.begin();
